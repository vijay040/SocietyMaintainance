...
public class DesignationAdapter extends BaseAdapter {
    public ArrayList<DesignationModel> list;
    public Activity context;


    public DesignationAdapter(Activity context, ArrayList<DesignationModel> list) {
        this.list = list;
    ...
    public void filter(ArrayList<DesignationModel> newList) {
        list = new ArrayList<>();
        list.addAll(newList);
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        txtTitle.setText(list.get(i).getDesignation());
