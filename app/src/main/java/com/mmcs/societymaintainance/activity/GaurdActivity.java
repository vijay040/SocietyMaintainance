...
public class GaurdActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(GaurdActivity.this,AddGuardActivity.class);
    ...
    public void getEmployee(String userid,String type ,String branchid) {
        ...
        Singleton.getInstance().getApi().getGuardList(userid,type ,branchid).enqueue(new Callback<EmployeeRestMeta>() {
            @Override
            public void onResponse(Call<EmployeeRestMeta> call, Response<EmployeeRestMeta> response) {
                ...
                employeeAdapter=new EmployeeAdapter(GaurdActivity.this,employeeModels);
