...
public class MaidDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employeeModel = (EmployeeModel) getIntent().getSerializableExtra(getString(R.string.maid_model));
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (employeeModel.getEnding_date().equalsIgnoreCase("")) {
                    ...
                    if(time_out.equals("")){
                        Toasty.error(MaidDetailActivity.this,"Select Ending Date", Toast.LENGTH_SHORT).show();
                    }
                    else{
    ...
    private void setTitle() {
        ...
        title.setText(getString(R.string.maid_detail));
    }
    private void back() {
