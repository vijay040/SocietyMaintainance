...
public class AddMaidActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(AddMaidActivity.this)
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.equals("")) {
                    ...
                    Toasty.error(AddMaidActivity.this, "Enter Password", Toast.LENGTH_SHORT).show();
                    return;
                } else if (present_add.equals("")) {
                    Toasty.error(AddMaidActivity.this, "Enter Present Address", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    Toasty.error(AddMaidActivity.this, "Select Joining Date", Toast.LENGTH_SHORT).show();
                    return;
                } else {
    ...
    private void setTitle() {
        ...
        title.setText(getString(R.string.add_md));
    }
    ...
    private void selectImage() {
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(AddMaidActivity.this);
    ...
    private void postEmployee(String userid,String type ,String branchid,String name ,String email, String mobile,String preaddress ,String peradress,String national_id,String date ,String password,String fileUrl) {
        ...
        Singleton.getInstance().getApi().postMaid(requestUserId, requesttype,requestUserbranch, requesttxtName,requestEmail ,requestMobile,requestpreAddress,requestper_Address,requestNational_id,requestdesign,requestJoiningDate,requestEndingDate,requestpassword,requestStatus,requestcurrentdate ,imgFile).enqueue(new Callback<LoginResMeta>() {
            ...
            public void onFailure(Call<LoginResMeta> call, Throwable t) {
                progress.setVisibility(View.GONE);
                Toasty.error(AddMaidActivity.this,"Sorry Try Again", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            ...
            Toast.makeText(AddMaidActivity.this, place.getAddress(), Toast.LENGTH_SHORT).show();
        ...
        Singleton.getInstance().getApi().getDesignationList(userid, type ,branchid).enqueue(new Callback<DesignationRestMeta>() {
            ...
            public void onResponse(Call<DesignationRestMeta> call, Response<DesignationRestMeta> response) {
                ...
                for (DesignationModel m:designationModels) {
                    if(m.getDesignation().equalsIgnoreCase("Maid"))
                        DesiId=m.getId();
                }
            }
