...
EditText edt_ending_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employeeModel = (EmployeeModel) getIntent().getSerializableExtra(getString(R.string.employee_model));
        ...
        image_employee.setOnTouchListener(new ImageMatrixTouchHandler(EmployeeDetailActivity.this));
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (employeeModel.getEnding_date().equalsIgnoreCase("")) {
                    ...
                    if(time_out.equals("")){
                        Toasty.error(EmployeeDetailActivity.this,"Select Ending Date", Toast.LENGTH_SHORT).show();
                    }
                    else{
    ...
    private void setTitle() {
        ...
        title.setText(getString(R.string.emp_detail));
    }
    private void back() {
