...
public class OthersDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Picasso.get().load(employeeModel.getImage()).transform(new CircleTransform()).placeholder(R.drawable.no_image).resize(100, 100).into(image_employee);
        image_employee.setOnTouchListener(new ImageMatrixTouchHandler(OthersDetailActivity.this));
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (employeeModel.getEnding_date().equalsIgnoreCase("")) {
                    ...
                    if(time_out.equals("")){
                        Toasty.error(OthersDetailActivity.this,"Select Ending Date", Toast.LENGTH_SHORT).show();
                    }
                    else{
